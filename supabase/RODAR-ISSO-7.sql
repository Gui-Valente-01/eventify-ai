-- =============================================================
-- Eventify AI — Parte 7: Error logs (monitoramento + IA agente)
-- =============================================================
...
create index if not exists error_logs_unresolved_idx on public.error_logs (created_at desc) where status = 'open';
